...
export default {
    ...
    settings: {
        ...
        morphology_engine_hybrid: "混合模式（推荐）",
        morphology_engine_legacy: "兼容模式",
        morphology_fallback: "形态学兜底策略",
        morphology_fallback_desc: "Conservative 仅在分析器不可用时生成活用；Aggressive 始终生成。",
    ...
    notices: {
        ...
        legacy_duplicate_blocked: "历史重复词会让直接编辑入口产生歧义。请从侧边栏打开具体词条，或先运行重复词审计。{0}",
        legacy_duplicate_edit_context: "当前词已存在历史重复。你仍可查看、删除或仅更新元数据，但改名/移动前请先清理重复词。{0}",
    ...
    modals: {
        ...
        color_blue: "蓝色",
        color_purple: "紫色",
        pronunciation_label: "发音（可选）",
        pronunciation_placeholder: "例如：/həˈloʊ/ 或 かな",
        pronunciation_placeholder_japanese: "例如：かな / カナ",
        pronunciation_placeholder_english: "例如：/həˈloʊ/",
